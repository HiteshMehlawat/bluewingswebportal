...
export class CountryService {
  ...
  parsePhoneNumber(
    ...
    for (const country of this.countries) {
      if (phoneNumber.startsWith(country.phoneCode)) {
        // Remove the country code and any hyphen separator
        let number = phoneNumber.substring(country.phoneCode.length);
  ...
  combinePhoneNumber(countryCode: string, phoneNumber: string): string {
